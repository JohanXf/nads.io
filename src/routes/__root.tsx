...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "nads.io creates a personalized bio link page for users, allowing them to share their online presence." },
      ...
      { name: "description", content: "nads.io creates a personalized bio link page for users, allowing them to share their online presence." },
      { property: "og:description", content: "nads.io creates a personalized bio link page for users, allowing them to share their online presence." },
    ],
    links: [
